function [mdice,mnmi,mcv]=cross_validation_mod_L_test(wd,prefix,part,sub_list,kc,iter,prob_thre,mpm_thre)
...
fp=fopen(strcat(wd,'/validation/',part,'_L_stability_index_test_1.txt'),'at');
if fp
